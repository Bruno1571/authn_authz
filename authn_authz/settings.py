"""
Django settings for authn_authz project.
...
SECRET_KEY = 'django-insecure-ljf7b_)_b^znc(cytkb9zi@ovwarl(7bmqu@7b238-v6c139b6'
...
WSGI_APPLICATION = 'authn_authz.wsgi.application'
